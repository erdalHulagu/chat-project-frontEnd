    ...
    return (
            ...
            <div className='w-full flex border-b  border-blue-950 top-0 hover:bg-slate-400'>
                    <div className='flex justify-between w-full'>
                        <div className=' '>
                            <img className='ml-3 mt-2 hover:border-purple-400 border-2 cursor-pointer w-14 h-14 rounded-full ' src="https://cdn.pixabay.com/photo/2023/07/11/13/28/bird-8120621_1280.jpg " alt="erdal" />{/*https://cdn.pixabay.com/photo/2023/07/11/13/28/bird-8120621_1280.jpg */}
