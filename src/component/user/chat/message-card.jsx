...
const MessageCard = ({ isRegUserMessage, content, img }) => {
    ...
    return (
        ...
        <div className=' text-slate-950 align-middle text-end '>
            ...
            <div className={` flex justify-center h- w-full items-center max-w-[50%] py-3 px-2 rounded ${isRegUserMessage ? "self-start bg-slate-200 text-slate-800" : "self-end bg-slate-400 text-white"}`}>
