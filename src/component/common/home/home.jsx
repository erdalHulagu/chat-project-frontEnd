...
import Main from '../../user/userHome/main';
        ...
        <div>
            <div fluid className="h-screen bg-purple-100 ">
                ...
                <div className="h-48 bg-blue-950  flex  justify-center shadow-2xl ">
                    ...
                    <div className=" h-[86vh] w-[94%] bg-gradient-to-b from-purple-300 via-purple-100 to-white absolute bottom-22  top-28   rounded shadow-2xl " >
