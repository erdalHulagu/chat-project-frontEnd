            ...
            <div className='w-[94%]flex  shadow-slate-600 shadow-md hover:bg-slate-200 '>
                    <div className='flex  justify-between items-center w-full'>
                        <div className='w-24 h-24 mt-3 rounded-full flex flex-col items-center '>
                            <img onClick={hadleMessageProfile} className=' hover:opacity-40 cursor-pointer w-14 h-14 rounded-full ' src={item.profileImage||"https://cdn.pixabay.com/photo/2018/04/18/18/56/user-3331256_1280.png" }alt="erdal" />{/*https://cdn.pixabay.com/photo/2023/07/11/13/28/bird-8120621_1280.jpg */}
