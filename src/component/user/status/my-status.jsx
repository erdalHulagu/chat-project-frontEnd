    ...
    <>
      ...
      {friendStatus ? <StatusDisplayer />
        ...
        <div className='h-full w-full flex absolute bg-slate-300 rounded'>
          ...
          <BiSolidLeftArrowSquare onClick={handleNavigate} className='  text-gray-800 w-14 h-14 p-3 hover:opacity-30 hover:bg-slate-400 hover:text-blue-950 cursor-pointer rounded-full' />
          ...
          <div className='h-full w-[60%] lg:w-[75%]'>
            <AiFillCloseCircle onClick={handleNavigate} className='absolute m-1  text-blue-950 w-14 h-14 p-3 hover:opacity-30 hover:bg-slate-100 hover:text-blue-950 cursor-pointer rounded-full right-0' />
