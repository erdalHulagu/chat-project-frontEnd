...
const FriendsCard = ({ name, surname,  img }) => {
    return (
        <div className="w-full h-50 p-2 mt-3 mx-4 rounded flex  justify-between  bg-gradient-to-b from-purple-300 via-purple-100 to-white hover:opacity-80 shadow-2xl shadow-slate-800">
